# Proyecto #1 Emily Arce Picado Curso de Laravel 8 From Scratch

## Contenido del curso

### The Basics

- [01 - How a Route Loads a View](./Basics/How-a-Route-Loads-a-View.md)
  
- [02 - Include CSS and JavaScript](./Basics/Include-CSS-and-JavaScript.md)
  
- [03 - Make a Route and Link to it](./Basics/Make-a-Route-and-Link-to-it.md)
  
- [04 - Store Blog Posts as HTML Files](./Basics/Store-Blog-Posts-as-HTML-Files.md)
  
- [05 - Route Wildcard Contraints](./Basics/Route-Wildcard-Contraints.md)
  
- [06 - Use Caching for Expensive Operations](./Basics/Use-Caching-for-Expensive-Operations.md)
  
- [07 - Use the Filesystem Class to Read a Directory](./Basics/Use-the-Filesystem-Class-to-Read-a-Directory.md)

- [08 - Find a Composer Package for Post Metadata](./Basics/Find-a-Composer-Package-for-Post-Metadata.md)

- [09 - Collection Sorting and Caching Refreshe ](./Basics/Collection-Sorting-and-Caching-Refresher.md)
