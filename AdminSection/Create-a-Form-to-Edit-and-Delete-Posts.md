...
- Creación de un archivo create para crear el nuevo post 
...
- Creación de un index ponde se manejan los estilos y estructura para el delete y el edit
...
- Creación de las rutas para el buen funcionamiento 